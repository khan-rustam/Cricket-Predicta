      ...
      <div className="container mx-auto px-6 md:px-10 lg:px-16 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white border-b border-primary/30 pb-2 inline-block">Quick Links</h3>
          ...
          {/* Contact Information */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white border-b border-primary/30 pb-2 inline-block">Contact Us</h3>
            <div className="space-y-3 text-slate-300">
              ...
              <p className="flex items-start gap-3">
                ...
                <span>123 Cricket Stadium Road, Mumbai, Maharashtra, India - 400001</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white border-b border-primary/30 pb-2 inline-block">Where to Watch</h3>
            <div className="space-y-3 text-slate-300">
              ...
              <div className="pt-2">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">Star Sports</span>
                  <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">DD Sports</span>
                  <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">Sony Ten</span>
                  <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">Regional Networks</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white border-b border-primary/30 pb-2 inline-block">Connect With Us</h3>
