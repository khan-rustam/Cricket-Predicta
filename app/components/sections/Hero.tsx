...
export function HeroSection() {
  return (
    <section id="home" className="container mx-auto py-12 md:py-24 px-6 md:px-10 lg:px-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 order-2 lg:order-1">
          ...
          <h1 className="text-5xl md:text-7xl font-bold animate-fade-in">
            Cricket <span className="text-primary animate-text-glow">Predicta</span>
          </h1>
          
          <p className="text-xl text-muted-foreground animate-slide-up max-w-md">
            Your ultimate destination for cricket predictions, analysis, and insights powered by advanced statistics.
          </p>
          ...
          <div className="animate-slide-up-delay space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Check className="h-5 w-5 text-primary" />
              <span className="text-sm">Expert analysis from cricket professionals</span>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-border/50 animate-fade-in-delay-2">
            <p className="text-xs text-muted-foreground mb-3">TRUSTED BY CRICKET ENTHUSIASTS WORLDWIDE</p>
        ...
        <div className="relative order-1 lg:order-2 animate-fade-in">
          <div className="relative h-[400px] md:h-[500px] w-full max-w-md mx-auto">
            ...
            <div className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-red-500 rounded-full animate-ping" style={{ animationDelay: "1s" }}></div>
            <div className="absolute top-1/2 left-1/3 w-2 h-2 bg-red-500 rounded-full animate-ping" style={{ animationDelay: "1.5s" }}></div>
            
            {/* Action lines */}
            <div className="absolute top-1/3 right-1/4 w-16 h-1 bg-primary/50 rounded-full rotate-45 animate-pulse-slow"></div>
            <div className="absolute top-1/2 right-1/3 w-12 h-1 bg-primary/50 rounded-full rotate-[30deg] animate-pulse-slow" style={{ animationDelay: "0.5s" }}></div>
          </div>
          ...
          <div className="absolute -bottom-10 -right-5 bg-background/80 backdrop-blur-md p-4 rounded-xl border border-border/50 shadow-lg animate-slide-up-delay max-w-xs hidden md:block">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Advanced match predictions</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute -top-10 -left-10 bg-background/80 backdrop-blur-md p-3 rounded-xl border border-border/50 shadow-lg animate-slide-up max-w-[200px] hidden md:block">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">From professionals</p>
              </div>
            </div>
          </div>
          
          <div className="absolute bottom-1/4 -right-10 bg-background/80 backdrop-blur-md p-3 rounded-xl border border-border/50 shadow-lg animate-slide-up-delay max-w-[180px] hidden md:block" style={{ animationDelay: "0.5s" }}>
            <div className="flex items-center gap-3">
              <div className="bg-primary/20 p-2 rounded-full">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Real-time scores</p>
              </div>
            </div>
          </div>
        </div>
