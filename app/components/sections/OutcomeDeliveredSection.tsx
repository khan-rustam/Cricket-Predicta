...
export function OutcomeDeliveredSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 right-10 w-80 h-80 bg-primary/5 rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-6 md:px-10 lg:px-16 relative z-10">
        <div className="max-w-2xl mx-auto text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 relative">
            Impact & Results <span className="text-primary relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-primary/50 after:rounded-full">Achieved</span>
          </h2>
        ...
        >
          ...
          >
            ...
            <p className="text-3xl font-bold text-primary mb-1 group-hover:scale-110 transition-all duration-300">250M+</p>
          ...
          >
            ...
            <p className="text-3xl font-bold text-primary mb-1 group-hover:scale-110 transition-all duration-300">98%</p>
            <p className="text-sm text-muted-foreground text-center">
              Prediction Accuracy
            </p>
          </div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-primary mb-1 group-hover:scale-110 transition-all duration-300">1.2M+</p>
            <p className="text-sm text-muted-foreground text-center">
              Engagements
            </p>
          </div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-primary mb-1 group-hover:scale-110 transition-all duration-300">4.8/5</p>
            <p className="text-sm text-muted-foreground text-center">
              User Rating
            </p>
          </div>
